      ...
      <div className="bg-white border text-white border-gray-400 p-8 rounded-lg w-[450px] backdrop-blur-md bg-opacity-20 shadow-lg">
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          <div>
            ...
            <input id="email" name="email" type="email" autoComplete="email" required className="bg-inherit mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:border-gray-300" onChange={(e) => setEmail(e.target.value)} />
          </div>
          <div>
