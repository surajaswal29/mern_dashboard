        ...
        <div className="navbar_container_1">
          ...
          <div className="nav_bar_links_1 relative">
            ...
            {/* chats */}
              ...
              <Link to={"/dashboard/chats"} className=" text-slate-500 cursor-pointer relative flex items-center justify-center" title="Chats" aria-label="Chats">
              <MdEmail size={20} />
              </Link>
            ...
            {/* notification */}
              ...
              <Link to={"/dashboard/notifications"} className=" text-slate-500 cursor-pointer relative flex items-center justify-center" title="Notification" aria-label="Notification">
